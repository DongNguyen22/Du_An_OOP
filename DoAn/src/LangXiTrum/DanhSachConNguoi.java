...
public class DanhSachConNguoi implements XuLiDuLieu {
    ...
    public void themKH(){
        ...
        String maNV = sc.nextLine();
        if(timKhMa(maNV) == null)
        {
        ds=Arrays.copyOf(ds, n+1);
        ds[n] = new KhachHang();
        ((KhachHang) ds[n]).setMaKH(maNV);
        ds[n++].nhap();
        }
        else{
            System.out.println("Da ton tai khach hang nay");
        }
    }
   ...
   inKetBangKH();
    ...
    try (BufferedReader br = new BufferedReader(
        ...
        while ((line = br.readLine()) != null) {
            ...
            if (parts[0].contains("NV")) {
                ...
                ds = Arrays.copyOf(ds, size + 1);
                ds[size++] = new KhachHang(maKH,ten, gtinh, sdt, diaChi);
            }
        }
        n = size;
    } catch (IOException e) {
    ...
    try (BufferedWriter bw = new BufferedWriter(
        ...
        System.out.println("Ghi file ConNguoi.txt thanh cong");
    } catch (IOException e) {
